...
router.post('/', function (req, res, next) {
  ...
  var data = [Alwin = { fname: 'Alwin', uname: 'alwin', pass: "123" }, Simon = { fname: 'Simon', uname: 'simon', pass: "321" }]
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    if (data[i].uname === username && data[i].pass === password) {
      ...
      req.session.username = name.fname
